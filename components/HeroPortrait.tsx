  ...
  return (
    <>
      ...
      >
        ...
        <div
          aria-hidden
          className={`absolute inset-0 pointer-events-none bg-[repeating-linear-gradient(0deg,rgba(0,0,0,0.22)_0px,rgba(0,0,0,0.22)_1px,transparent_1px,transparent_3px)] mix-blend-multiply transition-opacity duration-[1800ms] ease-out ${revealed ? "opacity-0" : "opacity-50"
            }`}
        />
