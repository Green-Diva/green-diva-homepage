            ...
            <nav className="flex-1 flex flex-col items-center justify-center gap-8 px-6">
              {items.map((item) => (
                <Link
                  ...
                  className={`font-label text-base tracking-[0.4em] uppercase pb-1 border-b min-h-[44px] flex items-center focus-visible:outline focus-visible:outline-2 focus-visible:outline-primary focus-visible:outline-offset-4 ${item.active
