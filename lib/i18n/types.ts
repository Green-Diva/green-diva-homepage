...
export interface Dictionary {
  ...
  relicCollection: {
    ...
    cutout2dConfigTitle: string;
    cutout2dConfigSubtitle: string;
    cutout2dModel: string;
    cutout2dModelHint: string;
    cutout2dModelLight: string;
    cutout2dModelLight2k: string;
    cutout2dModelHeavy: string;
    cutout2dModelMatting: string;
    cutout2dModelPortrait: string;
    cutout2dModelDynamic: string;
    cutout2dResolution: string;
    cutout2dResolutionHint: string;
    cutout2dResolution2304Note: string;
    cutout2dRefine: string;
    cutout2dRefineHint: string;
    cutout2dConfirm: string;
    cutout2dCancel: string;
    cutout2dSourceTitle: string;
    cutout2dHistoryTitle: string;
    cutout2dHistoryEmpty: string;
    cutout2dSelectedCount: string;
    cutout2dDeleteHistoryConfirm: string;
    cutout2dHistoryDoneBadge: string;
    cutout2dStep1: string;
    cutout2dStep2: string;
    cutout2dStep3: string;
    cutout2dDone: string;
    cutout2dRunningLabel: string;
    cutout2dBatchError: string;
    cutout2dCancelConfirm: string;
    cutout2dCancelConfirmYes: string;
    cutout2dCancelConfirmNo: string;
    enhanceBadgeLabel: string;
    meshy3dSourceTitle: string;
    meshy3dSourcePlaceholder: string;
    meshy3dStep1: string;
    meshy3dStep2: string;
    meshy3dStep3: string;
    meshy3dPreviewTitle: string;
    meshy3dPreviewEmpty: string;
    meshy3dPreviewRunning: string;
    meshy3dDone: string;
    meshy3dParamsSummary: string;
    meshy3dParamsOn: string;
    meshy3dParamsOff: string;
    meshy3dParamsDefault: string;
    meshy3dParamsTextureNone: string;
    meshy3dModelStatsTitle: string;
    meshy3dModelTriangles: string;
    meshy3dModelVertices: string;
    meshy3dModelMaterials: string;
    meshy3dModelTextures: string;
    meshy3dModelSize: string;
    meshy3dModelStatsLoading: string;
    meshy3dModelStatsFailed: string;
    meshy3dUploadOr: string;
    meshy3dUploadButton: string;
    meshy3dUploadHint: string;
    meshy3dUploadRunning: string;
    meshy3dUploadFailed: string;
    ...
    originBadgeNetwork: string;
    originNavPrev: string;
    originNavNext: string;
    originSourceLink: string;
  };
  agentControl: {
    pageTitle: string;
