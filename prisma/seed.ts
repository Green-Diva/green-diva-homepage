...
const AGENT_SEEDS = [
  ...
  },
  {
    ...
    status: "STANDBY" as const,
    descriptionEn:
      "Receives a goal and self-composes capability chains to reach it — no fixed pipeline. Plans, acts, observes, replans until done.",
    descriptionZh:
      "接收目标，自行编排能力链条以达成；无固定流水线。规划、执行、观测、再规划，直至完成。",
    syncLevel: 87.4,
    matrixLevel: 11,
    quickness: 73,
    intelligence: 96,
