...
const RELIC_SEEDS = [
  {
    ...
    nameEn: "Holy Chalice",
    nameZh: "圣杯",
    classifEn: "BLOODBORNE · HOLY CHALICE",
    classifZh: "血源诅咒 · 圣杯",
  ...
  },
  {
    ...
    nameEn: "Data Shard",
    nameZh: "数据碎片",
    classifEn: "ARCHIVE · ENCRYPTED FRAGMENT",
    classifZh: "档案 · 加密残片",
  ...
  },
  {
    ...
    nameEn: "Core Node",
    nameZh: "核心节点",
    classifEn: "INFRASTRUCTURE · CRITICAL",
    classifZh: "基础设施 · 关键",
  ...
  },
  {
    ...
    nameEn: "Void Sphere",
    nameZh: "虚空之球",
    classifEn: "ANOMALY · CONTAINMENT-CRITICAL",
    classifZh: "异常 · 须严密封存",
  ...
  },
  {
    ...
    nameEn: "Frame Lock",
    nameZh: "镜匣封印",
    classifEn: "FATAL FRAME · SEALED CAMERA",
    classifZh: "零 · 封印之匣",
  ...
  },
  {
    ...
    nameEn: "Access Key",
    nameZh: "通行钥",
    classifEn: "SECURITY · MASTER CYLINDER",
    classifZh: "安全 · 主钥筒",
    rarity: "SPECIAL" as const,
    iconKey: "key",
