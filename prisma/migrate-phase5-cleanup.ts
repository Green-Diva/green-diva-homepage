...
//
// What it does (post-2026-05-11):
//   - Strips RELIC-SCRIBE-001's stale loadout: the cutout (slot 3) +
//     meshy (slot 4) equips and the backbone DAG nodes/edges that
//     reference them.
//   - Drops the 3 now-orphaned Skill rows (relic-cutout, meshy-3d,
//     relic-image-pick).
//
// Historical: also seeded outputMap on relic.{draft,regen}-metadata —
// removed when SceneBinding.outputMap was retired in favor of fixed
// scene outputSchema + agent tail transforms.
//
